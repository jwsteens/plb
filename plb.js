    ...
    switch(args[0]) {
        ...
        case 'checkentries':
            ...
            try {
                ...
                let birthtime =new Date(fs.statSync(preferences().datadirectory+ "/" + username + '.json').birthtimeMs);
                var timeprefix = `${birthtime.toDateString()}`;
                ...
                .setFooter("Since " + timeprefix);
                message.channel.send(sendmessage);
                log(`Displayed patrollogs for ${username}`, "Logs requested", message.author);
                break;
            }
            catch (e){
                message.channel.send("No logs were found under this username.: " + e);
                return;
            }
        ...
        case 'deletealllogs':
            ...
            .then(collected => {
                ...
                fs.mkdirSync(preferences().datadirectory);
        ...
        case 'info':
            ...
            .setColor(preferences().color)
            .addField("Disclaimer", "This bot saves no personal data. It only saves the data you save, and it keeps logs of whoever makes use of the bot (saving the Discord tag). A select few can interact with the logging system. The bot is now Open Source too!")
            ...
            .addField("Want this bot?", "I've made this bot open sourced and available on [GitHub.](https://github.com/jwsteens/plb) I haven't made an attempt to make it incredibly easy to set up, but if you take the time and know a bit about JavaScript you can get it up pretty easily.")
